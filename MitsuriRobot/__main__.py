...
import MitsuriRobot.modules.sql.users_sql as sql
from MitsuriRobot.modules.sudoers import bot_sys_stats as bss

from MitsuriRobot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater, pgram, pbot)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from MitsuriRobot.modules import ALL_MODULES
from MitsuriRobot.modules.helper_funcs.chat_status import is_user_admin
from MitsuriRobot.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
*Hey Asshole {},*
*Myself Mitsuri, Love Hashira As Well As A Powerful Group Management Bot.*
...
*• @MitsuriGroupBot Powered By* [AOGIRI](https://t.me/AogiriNetwork)
"""

buttons = [
    [
                        InlineKeyboardButton(
                             text="➕️ Add Mitsuri To Your Chat ➕️",
                             url="https://t.me/MitsuriGroupBot?startgroup=true"),
                    ],
                   [
                       InlineKeyboardButton(
                             text="Aogiri",
...
ABOUT2 = """
*‣ Mitsuri Support Chats*\nJoin My Support Group/Channel For Reporting Problems And Updates On @MitsuriGroupBot.
"""

REPO_TXT = """
*‣ Owner:*
• [UNKNOWN](t.me/XTHEANONYMOUS)
\n*‣ Note:*
• If You Want This Bot's Repo You Can Get It From The Button Below.
• Report Any Kind Of Bugs At [Support](t.me/Mitsuri_botsupport)
"""

ABOUT3 = """Hello [{}], My name is *Mitsuri Kanroji*. A Powerful Telegram Group Management Bot built to help you manage Group easily.
...
Asuka_IMG = (
      "https://telegra.ph//file/cf06ceed3e723c17f43c4.jpg",
      "https://telegra.ph//file/dbd7a7b3a2c964d4465c2.jpg",
      "https://telegra.ph//file/801b45fdecb745b3109e4.jpg",
      "https://telegra.ph//file/4340e0ec49d905b83b5f9.jpg",
      "https://telegra.ph//file/ef8a89dc8e98009de08e0.jpg",
)

TEXXT = "Yes As!hole, I Am Alive And Working Fine.\nCheck Out The Buttons Mentioned Below.",
...
Asuka_PIC = "https://telegra.ph//file/801b45fdecb745b3109e4.jpg"

Asuka_VID = "https://telegra.ph//file/4340e0ec49d905b83b5f9.jpg"

PM_PHOTO = "https://telegra.ph//file/4340e0ec49d905b83b5f9.jpg"

Asuka_DISPACHER_PIC = "https://telegra.ph//file/dbd7a7b3a2c964d4465c2.jpg"

DONATE_STRING = """ Adding Me To Your Groups Is Donation For Me Though I Would Appreciate If You Join My Creator's Network @AogiriNetwork"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("MitsuriRobot.modules." +
                                              module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
                video="https://telegra.ph//file/85653833e8ab7eaa23d64.mp4",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                       InlineKeyboardButton(
                             text="Support",
                             url="t.me/Mitsuri_BotSupport"),
                       InlineKeyboardButton(
                             text="Updates",
                             url="t.me/MitsuriUpdates")
                     ]
                ]
            ),
        )
        ...
        if mod_match:
            ...
            help_buttons.append(
                [
                    ...
                    InlineKeyboardButton(text='Support', url='https://t.me/Mitsuri_botsupport')
                ]
                    )
    ...
    if query.data == "about_":
        ...
        query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/Mitsuri_botsupport"),
                    InlineKeyboardButton(text="Updates", url="t.me/MitsuriUpdates"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="asuka_")
                 ],
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Aogiri", url="t.me/AogiriNetwork"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="asuka_")
                 ],
    ...
    if update.effective_chat.type != update.effective_chat.PRIVATE:
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text=" Click here", url="https://t.me/MitsuriGroupBot?start=help")
                  ]
                ]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            ...
            LOGGER.warning(
                "Mitsuri can't able to send message to support_chat, go and check!")
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Finally Mitsuri Is Online")
