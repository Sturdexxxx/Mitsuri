...
from MitsuriRobot.modules.helper_funcs.decorators import Asukacmd, Asukamsg
...
@Asukacmd(command="antichannel", group=100)
...
@Asukamsg(Filters.chat_type.groups, group=110)
