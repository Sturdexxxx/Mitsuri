...
from MitsuriRobot import dispatcher  # BAN_STICKER
from MitsuriRobot.modules.disable import DisableAbleCommandHandler
from MitsuriRobot.modules.helper_funcs.alternate import typing_action
...
from MitsuriRobot.modules.helper_funcs.extraction import (
    extract_text,
...
from MitsuriRobot.modules.helper_funcs.string_handling import split_quotes
from MitsuriRobot.modules.log_channel import loggable
from MitsuriRobot.modules.sql import warns_sql as sql
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Rules", url="http://t.me/MitsuriRobot?start={}".format(chat.id)
                    )
                ]
            ]
        )
