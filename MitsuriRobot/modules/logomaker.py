...
from MitsuriRobot import telethn as tbot

from MitsuriRobot import OWNER_ID, BOT_USERNAME, SUPPORT_CHAT
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./MitsuriRobot/resources/Vampire Wars.otf")
