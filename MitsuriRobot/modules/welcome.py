...
import MitsuriRobot.modules.sql.welcome_sql as sql
from MitsuriRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, EVENT_LOGS, JOIN_LOGGER, pgram)
from MitsuriRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from MitsuriRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from MitsuriRobot.modules.helper_funcs.msg_types import get_welcome_type
from MitsuriRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from MitsuriRobot.modules.log_channel import loggable
from MitsuriRobot.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                Asuka_IMG, caption= "Behold!!! Owner Of @MitsuriRobot Joined Your Chat.",
                    reply_to_message_id=reply)
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the @Mitsuri_BotSupport!",
                    reply_to_message_id=reply,
                )
                return
