...
import MitsuriRobot.modules.sql.connection_sql as sql
from MitsuriRobot import dispatcher, DRAGONS, DEV_USERS
from MitsuriRobot.modules.helper_funcs import chat_status
