...
from MitsuriRobot.modules.helper_funcs.misc import article
from MitsuriRobot.modules.helper_funcs.decorators import Asukainline
    ...
    inline_help_dicts = [
        {
        ...
        },
         {
            ...
            "message_text": "Click the button below to get the links.",
            "thumb_urL": "https://telegra.ph//file/dbd7a7b3a2c964d4465c2.jpg",
            "keyboard": ".anime",
        },
        {
            "title": "Asuka",
            "description": "MitsuriRobot Inline",
        ...
        {
            "title": "AOGIRI",
            "description": "The AOGIRI",
            "message_text": "Click the button below to get the AOGIRI Network Info.",
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Report Error",
                    url=f"https://t.me/Mitsuri_BotSupport",
                ),
                InlineKeyboardButton(
                    text="Search again",
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Asuka Robot",
                    url=f"https://t.me/MitsuriGroupBot",
                ),
        ...
        kb = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="Report error",
                        url="https://t.me/Mitsuri_BotSupport",
                    ),
                    InlineKeyboardButton(
                        text="Search again",
                        switch_inline_query_current_chat=".anilist ",
...
def help(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    help_text = f"""
     [Mitsuri Inline Help](https://t.me/mITSURIgROUPbOT)\n*Inline Help Commands:*\n*• .hentai:* `You Can Get Hentai Links`\n*• .AOGIRI* `To Check Out AOGIRI Network`\n*• .anilist:* `To Search Animes And Mangas`\n*• .info:* `To Check Your Information`\n• Want your own inline on @MitsuriRobot? You can get it in low pricing by contacting @Xelcius
     """
    results: list = []
    kb = InlineKeyboardMarkup(
        [
    ...
    results.append(
        InlineQueryResultPhoto(
            id=str(uuid4()),
            title="Help Commands",
            thumb_url="https://telegra.ph//file/cf06ceed3e723c17f43c4.jpg",
            photo_url="https://telegra.ph//file/dbd7a7b3a2c964d4465c2.jpg",
            caption=help_text,
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=kb,
        )
...
def AOGIRI(query: str, update: Update, context: CallbackContext) -> None:
    """Handle the inline query."""
    query = update.inline_query.query
    user_id = update.effective_user.id
    user = context.bot.get_chat(user_id)
    ...
    results.append(
        InlineQueryResultPhoto(
            id=str(uuid4()),
            title="AOGIRI",
            description="Get AOGIRI Network Link",
            thumb_url="https://telegra.ph//file/dbd7a7b3a2c964d4465c2.jpg",
            photo_url="https://telegra.ph//file/dbd7a7b3a2c964d4465c2.jpg",
            caption=about_text,
            parse_mode=ParseMode.MARKDOWN,
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Join Now",
                    url=f"https://t.me/Hentai_Sekaii",
                ),
