...
from MitsuriRobot.__main__ import STATS, TOKEN, USER_INFO
from MitsuriRobot.modules.sql import SESSION
import MitsuriRobot.modules.sql.userinfo_sql as sql
...
from MitsuriRobot.modules.redis.afk_redis import is_user_afk, afk_reason
from MitsuriRobot.modules.sql.users_sql import get_user_num_chats
from MitsuriRobot.modules.helper_funcs.chat_status import sudo_plus
...
def info(update: Update, context: CallbackContext):
    ...
    [
                        InlineKeyboardButton(
                             text="Health",
                             url="https://t.me/Mitsuri_BotSupport/4"),
                       InlineKeyboardButton(
                             text="Disasters",
                             url="https://t.me/Mitsuri_BotSupport/5"),
                    ],
    ]
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_photo(
            ...
            + f"\n\n[Support](https://t.me/{SUPPORT_CHAT}) | [Updates](https://t.me/Mitsuri_BotSupport)\n\n"
            + "\n╘══「 by [The AOGIRI](https://t.me/TheAOGIRI) 」\n",
            parse_mode=ParseMode.MARKDOWN,
