...
from MitsuriRobot import pbot as app
from MitsuriRobot import DRAGONS, DEV_USERS, WOLVES, DEMONS, TIGERS
from MitsuriRobot.utils.adminperms import member_permissions
